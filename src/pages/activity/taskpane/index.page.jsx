...
const insertActivityApi = (payload) =>
  applyMutation("addActivity", { input: payload }, ["workEffortId"]);

//#endregion

//#region React Query Hooks
const useWorkEffortTypes = () =>
  useQuery("WorkEffortTypes", fetchWorkEffortTypes);
const useWorkEffortCategoryByEffortType = (typeId) =>
  useQuery(
    `workCategoryByTypeId-${typeId}`,
    () => fetchWorkEffortCategoryByEffortType(typeId),
    { enabled: !!typeId }
  );
const useSearchDynamicEntity = (entityQueryMap, value) => {
  return useQuery(
    `search-${entityQueryMap?.entity}-${value}`,
    () => searchDynamicEntity(entityQueryMap, value),
    {
...
const useInsertActivity = () =>
  useMutation({ mutationFn: (args) => insertActivityApi(args) });
//#endregion
...
const App = () => {
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      setErrorMsg(null);
      setSubmitting(true);
      const authResults = await handleAuth();
      const email = authResults?.mail;
      const username = extractNameFromEmail(email);
      // const username = undefined; //TEMP!!!
      try {
        const toSave = {
          ...values,
          userId: username,
        ...
        setErrorMsg("Error saving activity.");
      }
  ...
  const [entitySearchStr, setEntitySearchStr] = React.useState("a");
  const [productsSearchStr, setProductsSearchStr] = React.useState("a");
  const [consultantsSearchStr, setConsultantsSearchStr] = React.useState("a");
  const [investmentManagersSearchStr, setInvestmentManagersSearchStr] =
    React.useState("a");
  const [employeesSearchStr, setEmployeesSearchStr] = React.useState("a");
  const [entityMapContext, setEntityMapContext] = React.useState(null);
  const isWorkEffortAvailable = (value) =>
    toTrimAndLowerCase(value) === "plansponsor";
  const { mutateAsync: insertActivityAsync, isSuccess: insertActivitySuccess } =
    useInsertActivity();
  const { data: workEffortTypes, isLoading: workEffortTypesLoading } =
    useWorkEffortTypes();
  const { data: workEffortCategories, isLoading: workEffortCategoriesLoading } =
    useWorkEffortCategoryByEffortType(formik.values.workEffortTypeId);
  const {
    data: dynamicSearchResults,
    isLoading: dynamicSearchResultsIsLoading,
  } = useSearchDynamicEntity(entityMapContext, entitySearchStr);
  const {
    data: productsSearchResults,
    isLoading: productsSearchResultsIsLoading,
  } = useSearchProducts(productsSearchStr);
  const {
    data: consultantsSearchResults,
    isLoading: consultantsSearchResultsIsLoading,
  } = useSearchConsultants(consultantsSearchStr);
  const {
    data: investmentManagersSearchResults,
    isLoading: investmentManagersSearchResultsIsLoading,
  } = useSearchInvestmentManagers(investmentManagersSearchStr);

  const {
    data: employeesSearchResults,
    isLoading: employeesSearchResultsIsLoading,
  } = useSearchEmployees(employeesSearchStr);
    ...
    <form onSubmit={formik.handleSubmit}>
      ...
      >
        <h3 style={{ textAlign: "center" }}>
          Create{" "}
          {
            workEffortTypes?.find(
              (x) => x.workEffortTypeId === formik.values.workEffortTypeId
            )?.subjectArea
          }
          Activity
        </h3>
        <Loading
          center
          isLoading={workEffortTypesLoading || formik.isSubmitting}
        />
                  ...
                  onClick={() => {
                    ...
                    const entityMap = searchEntityQueryMap.find(
                      (x) =>
                        ...
                        toTrimAndLowerCase(
                          workEffortTypes?.find(
                            (x) => x.workEffortTypeId === v.workEffortTypeId
                          )?.subjectArea
                        )
                    );
          ...
          <>
            ...
            <Autocomplete
              ...
              isOptionEqualToValue={(option, value) =>
                option[entityMapContext?.idField] ===
                value[entityMapContext?.idField]
              }
              onChange={(e, value) =>
                formik.setFieldValue(
                  "primaryItemId",
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  fullWidth
                  error={
                    formik.touched.primaryItemId &&
                    Boolean(formik.errors.primaryItemId)
                  }
                  helperText={
                    formik.touched.primaryItemId && formik.errors.primaryItemId
                  }
                  sx={{ marginRight: "5px" }}
                  label={
                    workEffortTypes?.find(
                      (x) =>
                        x.workEffortTypeId === formik.values.workEffortTypeId
                    )?.subjectArea
                  }
                />
              )}
            ...
            <FormControl>
              ...
              <Select
                ...
                onBlur={formik.handleBlur}
                helperText={
                  formik.touched.workEffortCategoryId &&
                  formik.errors.workEffortCategoryId
                }
                error={
                  formik.touched.workEffortCategoryId &&
                  Boolean(formik.errors.workEffortCategoryId)
                }
                onChange={(event) =>
                  formik.setFieldValue(
                    "workEffortCategoryId",
            ...
            <DateTimePicker
              ...
              error={
                formik.touched.workEffortDate &&
                Boolean(formik.errors.workEffortDate)
              }
              helperText={
                formik.touched.workEffortDate && formik.errors.workEffortDate
              }
              onChange={(value) =>
                formik.setFieldValue("workEffortDate", value)
              }
            ...
            <TextField
              ...
              rows={4}
              helperText={
                formik.touched.commentsClob && formik.errors.commentsClob
              }
              value={formik.values.commentsClob}
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              error={
                formik.touched.commentsClob &&
                Boolean(formik.errors.commentsClob)
              }
            />
            {/* Private Comments */}
            <TextField
              ...
              rows={4}
              helperText={
                formik.touched.privateComments && formik.errors.privateComments
              }
              value={formik.values.privateComments}
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              error={
                formik.touched.privateComments &&
                Boolean(formik.errors.privateComments)
              }
            />
            {/* Products */}
            <Autocomplete
              ...
              onInputChange={(event, newValue) =>
                setProductsSearchStr(newValue)
              }
              isOptionEqualToValue={(option, value) =>
                option.ssiId === value.ssiId
              }
            ...
            <Autocomplete
              ...
              onInputChange={(event, newValue) =>
                setConsultantsSearchStr(newValue)
              }
              isOptionEqualToValue={(option, value) =>
                option.ssiId === value.ssiId
              }
              ...
              renderInput={(params) => (
                <TextField
                  ...
                  fullWidth
                  error={
                    formik.touched.consultants &&
                    Boolean(formik.errors.consultants)
                  }
                  helperText={
                    formik.touched.consultants && formik.errors.consultants
                  }
                  sx={{ marginRight: "5px" }}
                  label={"Consultants"}
                />
            ...
            <Autocomplete
              ...
              onInputChange={(event, newValue) =>
                setInvestmentManagersSearchStr(newValue)
              }
              isOptionEqualToValue={(option, value) =>
                option.ssiId === value.ssiId
              }
              onChange={(e, value) =>
                formik.setFieldValue("investmentManagers", value)
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  fullWidth
                  error={
                    formik.touched.investmentManagers &&
                    Boolean(formik.errors.investmentManagers)
                  }
                  helperText={
                    formik.touched.investmentManagers &&
                    formik.errors.investmentManagers
                  }
                  sx={{ marginRight: "5px" }}
            ...
            <Autocomplete
              ...
              onInputChange={(event, newValue) =>
                setEmployeesSearchStr(newValue)
              }
              isOptionEqualToValue={(option, value) =>
                option.ssiId === value.ssiId
              }
              onChange={(e, value) =>
                formik.setFieldValue("representatives", value)
              }
              renderInput={(params) => (
                <TextField
                  {...params}
                  ...
                  error={
                    ...
                    Boolean(formik.errors.representatives)
                  }
                  helperText={
                    formik.touched.representatives &&
